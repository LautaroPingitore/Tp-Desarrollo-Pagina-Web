...
const Home = () => {    const alojamientos = [
        ...
        },
        {
            ...
            bedrooms: 2,
            bathrooms: 1,
            amenities: ['WiFi', 'Fireplace', 'Kitchen', 'Parking', 'BBQ Grill']
        },
        {
            id: 3,
        ...
        },
        {
            ...
            bedrooms: 4,
            bathrooms: 3,
            amenities: ['WiFi', 'Pool', 'Kitchen', 'Parking', 'AC', 'Hot Tub']
        },
        {
            id: 5,
        ...
        },
        {
            ...
            bedrooms: 3,
            bathrooms: 2,
            amenities: ['WiFi', 'Kitchen', 'BBQ Grill', 'Parking']
        }/* ,
        {
            id: 7,
        ...
        },
        {
            ...
            descripcion: "Un hotel de lujo con spa y restaurante",
            precio: 400,
            imagen: "https://via.placeholder.com/150"
        },
        {
            ...
            descripcion: "Una cabaña rústica con chimenea",
            precio: 70,
            imagen: "https://via.placeholder.com/150"
        } */
    ];    return (
