...
const NavBar = () => {
    ...
    return (
        <nav className="bg-gray-900 text-gray-100 w-full flex relative justify-between items-center mx-auto px-8 h-20 border-b border-gray-700">
            ...
            <div className="flex-initial">
                <div className="flex justify-end items-center relative">
                    ...
                    <div className="block">
                        ...
                        {menuOpen && (
                            <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-gray-800 py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical">
