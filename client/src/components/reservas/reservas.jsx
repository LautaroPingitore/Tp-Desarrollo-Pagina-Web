...
import { getReservasAnfitrion, getReservasHuesped, confirmarReserva, cancelarReserva } from '../../api/api'
                ...
                <div key={reservation.id} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-gray-700 transition-colors">
                  <div className="md:flex">
                    ...
                    <div className="p-6 flex-1">
                        ...
                        <div className="flex items-center space-x-3 mb-4 p-3 bg-gray-800 rounded-lg">
                          <div className="flex-1 text-center">
                            <p className="text-white font-semibold text-lg mb-1">
                              {reservation.huespedReservador.nombre} {reservation.huespedReservador.apellido}
                            </p>
                            <div className="flex justify-center items-center text-base text-emerald-300 font-medium">
                      ...
                      {tipoUsuario === 'anfitrion' && reservation.estado === 'PENDIENTE' && (
                        <div className="flex justify-center">
                          <button
                            onClick={() => aceptarReserva(reservation.id)}
                      ...
                      {tipoUsuario === 'huesped' && reservation.estado === 'CONFIRMADA' && (
                        <div className="flex justify-center">
                          <button
                            onClick={() => rechazarReserva(reservation.id)}
